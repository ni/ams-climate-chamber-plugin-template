...
AddOutputFilter chunkFilter
		...
		<Item Name="gRPC" Type="Folder">
			...
			<Item Name="Custom" Type="Folder">
				<Item Name="BLSClimateChamberTemplateService_client.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSClimateChamberTemplateService_client/BLSClimateChamberTemplateService_client.lvlib"/>
				<Item Name="BLSClimateChamberTemplateService_server.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSClimateChamberTemplateService_server/BLSClimateChamberTemplateService_server.lvlib"/>
			</Item>
			<Item Name="Client Wrapper APIs" Type="Folder">
				...
				<Item Name="Plug-in Specific" Type="Folder">
					<Item Name="BLSClimateChamberTemplateService_Client_Wrapper.lvlib" Type="Library" URL="../Plugin/Custom gRPC/BLSClimateChamberTemplateService_Client_Wrapper/BLSClimateChamberTemplateService_Client_Wrapper.lvlib"/>
				</Item>
			</Item>
		</Item>
		<Item Name="Tests" Type="Folder">
			...
			<Item Name="Test BLS Climate Chamber Template.vi" Type="VI" URL="../Tests/Test BLS Climate Chamber Template.vi"/>
			<Item Name="Test BLS Climate Chamber Template UI.vi" Type="VI" URL="../Tests/Test BLS Climate Chamber Template UI.vi"/>
			<Item Name="Create Config JSON.vi" Type="VI" URL="../Tests/Create Config JSON.vi"/>
		</Item>
		<Item Name="BLS Climate Chamber Template.lvlib" Type="Library" URL="../Plugin/BLS Climate Chamber Template.lvlib"/>
		<Item Name="Climate Chamber.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/High Level Capabilities/Climate Chamber/Climate Chamber.lvclass"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Capabilities.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Capabilities.lvclass"/>
				<Item Name="Utilities.lvlib" Type="Library" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Utilities/Utilities.lvlib"/>
				<Item Name="Setpoint.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Parents/Setpoint/Setpoint.lvclass"/>
				<Item Name="Actual Value.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Parents/Actual Value/Actual Value.lvclass"/>
				<Item Name="Gradient.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Parents/Gradient/Gradient.lvclass"/>
				<Item Name="Limit.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Parents/Limit/Limit.lvclass"/>
				<Item Name="OnOff.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/OnOff/OnOff.lvclass"/>
				<Item Name="Temperature Setpoint.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Temperature/Temperature Setpoint/Temperature Setpoint.lvclass"/>
				<Item Name="Temperature Actual Value.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Temperature/Temperature Actual Value/Temperature Actual Value.lvclass"/>
				<Item Name="Error.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Error/Error.lvclass"/>
				<Item Name="Temperature Gradient.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Temperature/Temperature Gradient/Temperature Gradient.lvclass"/>
				<Item Name="Temperature Limit.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Temperature/Temperature Limit/Temperature Limit.lvclass"/>
				<Item Name="Humidity Setpoint.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Humidity/Humidity Setpoint/Humidity Setpoint.lvclass"/>
				<Item Name="Humidity Limit.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Humidity/Humidity Limit/Humidity Limit.lvclass"/>
				<Item Name="Humidity Gradient.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Humidity/Humidity Gradient/Humidity Gradient.lvclass"/>
				<Item Name="Humidity Actual Value.lvclass" Type="LVClass" URL="/&lt;vilib&gt;/Capabilities/Capabilities/Low Level Capabilities/Humidity/Humidity Actual Value/Humidity Actual Value.lvclass"/>
			</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="BLS Climate Chamber Template" Type="Packed Library">
				<Property Name="Bld_buildCacheID" Type="Str">{D76F4729-9418-4C5D-82BE-02A5C60CFE91}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">BLS Climate Chamber Template</Property>
				...
				<Property Name="Destination[0].destName" Type="Str">BLS Climate Chamber Template.1.0.lvlibp</Property>
				<Property Name="Destination[0].path" Type="Path">/usr/lib/x86_64-linux-gnu/ni-evo-engine/plugins/BLS Climate Chamber Template.1.0.lvlibp</Property>
				...
				<Property Name="TgtF_fileDescription" Type="Str">BLS Climate Chamber Template</Property>
				<Property Name="TgtF_internalName" Type="Str">BLS Climate Chamber Template</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2022 NI</Property>
				<Property Name="TgtF_productName" Type="Str">BLS Climate Chamber Template</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{E1985B85-F159-441F-9EAD-7499C0C5512C}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">BLS Climate Chamber Template.1.0.lvlibp</Property>
